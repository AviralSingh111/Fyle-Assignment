...
// This Function Will Work After Submitting Form And Send Post req to getform and After successfull submission user will get alert of Successfull Submission
    document.getElementById('contactForm').addEventListener('submit', function (event) {
        ...
        fetch("https://getform.io/f/bdrygwpb", {
            method: "POST",
            body: formData,
            headers: {
...
//This Function Will Change To Image When We Click On Content
